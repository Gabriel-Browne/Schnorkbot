//  This controls the behavior of all entities is a set of common helper functions

// BaseAi isn't a legitemate system itself, it is `extended` by BotAi and ZombieAi which use its methods
// this is to avoid repeated code since both ZombieAi and BotAi use mostly the same things....
